...
class RandomRotate(object):
    ...
    def __call__(self, image, landmarks):
        ...
        landmarks_after[0] = int(landmarks_[0].x)
        landmarks_after[1] = int(landmarks_[0].y)
        landmarks_after[2] = int(landmarks_[1].x)
        landmarks_after[3] = int(landmarks_[1].y)
        landmarks_after[4] = int(landmarks_[2].x)
        landmarks_after[5] = int(landmarks_[2].y)
        landmarks_after[6] = int(landmarks_[3].x)
        landmarks_after[7] = int(landmarks_[3].y)
        landmarks_after[8] = int(landmarks_[4].x)
        landmarks_after[9] = int(landmarks_[4].y)
