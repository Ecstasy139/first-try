...
class xmldataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        res = Rescale((256, 256))  # Resize
        rand = RandomCrop((224, 224))  # Random Crop
        ...
        ldmks = ldmks / 224  # Rescale the coordinates of landmarks to the range of 0 to 1
...
def main():
    ...
    for i, (imgs, label) in enumerate(datalo):
        print(i+1)
        if imgs.shape[1] == 1 or label.shape[1] != 10:
            print(i+1, imgs.shape, label.shape)
